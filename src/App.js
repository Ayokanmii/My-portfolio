  ...
  return (
    <div className="app">
      ...
      <section className="projects">
        ...
        <ul>
          <li>
            ...
            <a href="https://github.com/Ayokanmii/movie-recommendation-app" target="_blank" rel="noopener noreferrer">
              View on GitHub
            </a>
          </li>
          <li>
            <strong>⚛️ React Hello World App</strong> — An introductory React project focused on basic component rendering.
          </li>
          <li>
      ...
      <section className="contact">
        ...
        <p>LinkedIn: <a href="https://linkedin.com/in/olatunjiayokanmi" target="_blank" rel="noopener noreferrer">linkedin.com/in/olatunjiayokanmi</a></p>
